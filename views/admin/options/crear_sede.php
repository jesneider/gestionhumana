				...
				<form id="frm-crear-sede" class="form-horizontal" action="javascript:" method="post" autocomplete="off">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="nit_inst" class="form-control required">	
											<?php comboBox('gh_institucion', array('id_auto', 'nombre_institucion')); ?>
										</select>
									</div>
								</div>
								<div class="form-group">
					...
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-lg-8"><input id="btn-crea-sede" type="submit" class="btn btn-info" value="Registrar Sede"/></div>
						</div>
					</div>
				</form>
			</div>			
